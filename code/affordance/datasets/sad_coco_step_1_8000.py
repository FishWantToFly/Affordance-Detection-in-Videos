...
train / test_list_v1 : 8000 images
'''
...
class Sad_coco_step_1_8000(data.Dataset):
    def __init__(self, is_train = True, **kwargs):
        ...
        if kwargs['relabel']: # for relabel / visualization
            ...
            self.train_list = self.load_full_file_list('train_list_10_v1')
            self.valid_list = self.load_full_file_list('test_list_10_v1')
        else :
            # 100 and 109
...
def sad_coco_step_1_8000(**kwargs):
    return Sad_coco_step_1_8000(**kwargs)

sad_coco_step_1_8000.njoints = 1  # ugly but works
