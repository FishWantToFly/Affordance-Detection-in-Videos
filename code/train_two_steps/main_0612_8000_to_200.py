'''
fine tune from coco 8000 dataset to 200 good coco data
(from checkpoint_0605_coco_all_step_1, lr = 5e-4)

lr : 5e-5

# resume pre-training from checkpoint
python main_0612_8000_to_200.py --resume ./checkpoint_0605_coco_all_step_1/checkpoint_best_iou.pth.tar -p
...
def main(args):
    ...
    if args.resume != '' and args.pre_train == False: # prevent override checkpoint
   ...
   # optionally resume from a checkpoint
    ...
    os.system('cp ../affordance/datasets/sad_coco_step_1_200.py %s/%s/sad_coco_step_1_200.py' % (args.checkpoint, code_backup_dir)) # dataset
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', metavar='DATASET', default='sad_coco_step_1_200',
