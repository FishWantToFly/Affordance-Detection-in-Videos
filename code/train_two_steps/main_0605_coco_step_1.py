...
def main(args):
    ...
    os.system('cp ../affordance/datasets/sad_coco_step_1.py %s/%s/sad_coco_step_1.py' % (args.checkpoint, code_backup_dir))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', metavar='DATASET', default='sad_coco_step_1',
