'''
2020.7.3
use faster rcnn bbox to clip pred and gt bbox

python main_eval_0703_faster_rcnn.py --mask ./checkpoint_0428/pred_vis --resume ./checkpoint_0523_input_pred_mask/checkpoint_best_iou.pth.tar -e
            ...
            for j in range(6):
                ...
                if area_to_detect is not None :
                    ...
                    for _i in range(len(area_to_detect)):
                        ...
                        # clip pred
                        out_resized_area[0, 0, y_min:y_max, x_min:x_max] = input_mask_now[0, 0, y_min:y_max, x_min:x_max]

                        # clip GT
                        gt_resized_area[0, 0, y_min:y_max, x_min:x_max] = gt_mask_now[0, 0, y_min:y_max, x_min:x_max]
                ...
                if RELABEL:
                    ...
                    temp = os.path.join(temp_head, 'code/train_two_steps/eval_bbox_clip', 'pred_vis', temp_tail)
                    relabel_mask_dir, relabel_mask_name = os.path.split(temp)
