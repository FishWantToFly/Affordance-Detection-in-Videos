...
# temp
python main_0428.py --resume ./checkpoint/checkpoint_best_iou.pth.tar -w
'''
...
def main(args):
    ...
    elif args.dataset == 'sad' or args.dataset == 'sad_two_steps':
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', metavar='DATASET', default='sad_two_steps',
