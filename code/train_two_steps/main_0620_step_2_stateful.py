'''
copy from main_0522_step_2.py

1. hidden dim of convLSTM from 64, 32, 64 -> 64, 64, 64
2. stateful


# training 
python main_0620_step_2_stateful.py --mask ./checkpoint_0428/pred_vis

python main_0620_step_2_stateful.py --mask ./checkpoint_0613_coco_sad_train/pred_vis
...
# 2020.6.19
# LSTM_STATE = 'stateless'
LSTM_STATE = 'stateful'

print("LSTM STATE NOW : %s" % (LSTM_STATE))
...
def main(args):
    ...
    os.system('cp ../affordance/models/convlstm.py %s/%s/convlstm.py' % (args.checkpoint, code_backup_dir))
    os.system('cp ../affordance/datasets/sad_step_2_eval.py %s/%s/sad_step_2_eval.py' % (args.checkpoint, code_backup_dir))
